import { Student, StudentInformation, StudentLogin, StudentsByEvent, securityInformation } from "../entities/student";
...
export interface StudentRepository {
    ...
    getStudentsByEvent(usersByEvent: any[]): Promise<StudentsByEvent[] | any>;
}